...
def test_book_example_two_factors(get_app_ex_data, get_app_ex_loadings):
    """Test the book example for two factors."""
...
def test_fit_using_corr_mtx(get_app_ex_loadings):
    """Test the fit method using a correlation matrix as input."""
    loadings = get_app_ex_loadings
...
def get_app_ex_data():
    """Return the data from the book application example."""
    ...
    pth = os.path.join(
        ...
        "factor_analysis",
        "data",
        "application_example_backhaus_2021.CSV",
    )
...
def get_app_ex_loadings():
    """Return the loadings from the book application example."""
